...
class Repository {
  Future<bool> checkSession(String sessionToken) async {
    ...
    try {
      ...
      final response = await _dio.post(
          'https://api-flutter-deri.000webhostapp.com/api/session.php',
          data: fdata);
  ...
  Future logout() async {
    ...
    final response = await _dio.post(
        'https://api-flutter-deri.000webhostapp.com/api/logout.php',
        data: fdata);
  ...
  Future login({required String username, required String password}) async {
    ...
    fdata.fields.addAll(fdataMap.entries.map((e) => MapEntry(e.key, e.value)));
    final response = await _dio.post(
        'https://api-flutter-deri.000webhostapp.com/api/login.php',
        data: fdata);
    log("login $response");
